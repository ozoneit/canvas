...
ActiveRecord::Schema.define(:version => 20110405210006) do
  ...
  create_table "account_authorization_configs", :force => true do |t|
    ...
    t.text     "certificate_fingerprint", :limit => 255
    t.string   "entity_id"
  ...
  add_index "account_notifications", ["account_id", "start_at"], :name => "index_account_notifications_on_account_id_and_start_at"
  ...
  create_table "context_messages", :force => true do |t|
    ...
    t.string   "workflow_state"
    t.text     "viewed_user_ids",         :limit => 255
    t.string   "context_code"
  ...
  create_table "delayed_messages", :force => true do |t|
    ...
    t.datetime "send_at"
    t.string   "link"
    t.text     "name_of_topic",            :limit => 255
    t.text     "summary"
  end
  ...
  add_index "error_reports", ["created_at"], :name => "altered_error_reports_created_at"
  ...
  add_index "page_views", ["request_id"], :name => "index_page_views_request_id", :unique => true
  ...
  create_table "users", :force => true do |t|
    ...
    t.text     "features_used",               :limit => 255
    t.string   "sis_name"
    t.text     "preferences"
    t.string   "avatar_state"
  end

  add_index "users", ["creation_unique_id", "creation_sis_batch_id"], :name => "altered_users_sis_creation"
